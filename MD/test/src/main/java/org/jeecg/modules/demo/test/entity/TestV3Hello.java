 ...
 */
@Data
@TableName("test_v3_hello")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="test_v3_hello对象", description="第一个Vue3表单")
public class TestV3Hello implements Serializable {
